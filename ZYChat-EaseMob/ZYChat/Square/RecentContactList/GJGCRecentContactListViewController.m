...
- (void)sendMessageContentWithConversation:(GJGCInfoBaseListContentModel *)contentModel
{
    ...
    [[EMClient sharedClient].chatManager asyncSendMessage:sendMessage progress:nil completion:^(EMMessage *message, EMError *error) {
...
- (EMMessage *)sendWebPageWithToUserId:(NSString *)toId withNotDisplayText:(NSString *)displayText
{
    ...
    EMTextMessageBody *body = [[EMTextMessageBody alloc] initWithText:notSupportDisplayText];
